...
namespace FoodPlanner.Controllers
{
    public class HouseholdsController : Controller
    {
        ...
        public HouseholdsController(FoodPlannerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] Household household, string AppUserId)
        {
            ...
            {
                // Add myself as a user of this household
                AppUser user = (AppUser)_context.Users.Where(au => au.Id == AppUserId).FirstOrDefault();

                if (user != null)
                {
                    if (household.HouseholdUsers == null)
                    {
